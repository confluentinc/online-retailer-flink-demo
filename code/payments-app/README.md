...
> **Windows Users**: If the scripts directory contains shell scripts, you can run them in PowerShell using `bash script_name.sh` (requires Git Bash) or use Windows Subsystem for Linux (WSL) for full compatibility.
